...
import { Heart, ShoppingCart, Star, MapPin, Filter } from "lucide-react"
...
const products = [
  ...
  },
  {
    ...
    category: "Vegetables",
    inStock: true,
    description: "Crunchy organic carrots, perfect for cooking or snacking",
  },
  {
    id: 4,
              ...
              <CardContent className="pt-0">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <div className="flex gap-2">
                    ...
                    <Button size="sm" className="bg-blue-600 hover:bg-blue-700" disabled={!product.inStock}>
